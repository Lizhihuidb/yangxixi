...
public class MyFragment extends OriginalFragment implements OnClickListener{
	...
	private void init(){
		mMessage = (LinearLayout) v.findViewById(R.id.ll_my_message);
		mServiceManual = (RelativeLayout) v.findViewById(R.id.rl_my_service_manual);
		mUseClauses = (RelativeLayout) v.findViewById(R.id.rl_my_use_clauses);
		mFeedback = (RelativeLayout) v.findViewById(R.id.rl_my_feedback);
		mAbout = (RelativeLayout) v.findViewById(R.id.rl_my_about);
		mVersion = (RelativeLayout) v.findViewById(R.id.rl_my_version);
