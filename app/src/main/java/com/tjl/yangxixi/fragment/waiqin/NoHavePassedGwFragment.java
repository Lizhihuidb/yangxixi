...
public class NoHavePassedGwFragment extends OriginalFragment implements OnRefreshListener2<ListView>{
	...
	private void init(View v){
		...
		http.doPost(ConstantsUrl.getApplicationByUser(user.getEmp_id(), "3", indexPage+""), 1, false);
	...
	public void onPullUpToRefresh(PullToRefreshBase<ListView> refreshView) {
		...
		http.doPost(ConstantsUrl.getApplicationByUser(user.getEmp_id(), "3", indexPage+""), 2, false);
	}
