...
public class MAlltaskAdapter extends RecyclerView.Adapter<MAlltaskAdapter.MyViewHolder>{

    private List<MAllTaskBean.DataBean> mList;
    private MyItemClickListener mListener;
    public MAlltaskAdapter(List<MAllTaskBean.DataBean> list) {
        mList = list;
    }

    @Override
    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        MAlltaskAdapter.MyViewHolder holder = new MAlltaskAdapter.MyViewHolder(
