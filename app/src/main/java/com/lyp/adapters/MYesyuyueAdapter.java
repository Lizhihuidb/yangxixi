 ...
 */
//已预约(我的任务)
public class MYesyuyueAdapter extends RecyclerView.Adapter<MYesyuyueAdapter.MyViewHolder>{

    private List<MYesyuyueBean.DataBean> mList;
    private MyItemClickListener mListener;
    public MYesyuyueAdapter(List<MYesyuyueBean.DataBean> list) {
        mList = list;
    }

    @Override
    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        MYesyuyueAdapter.MyViewHolder holder = new MYesyuyueAdapter.MyViewHolder(
